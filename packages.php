                ...
                <div class="card d-flex w-100 rounded-0 mb-3 package-item">
                    ...
                    <div class="card-body">
                        ...
                        <div class="w-100 d-flex justify-content-between">
                            <span class="rounded-0 btn btn-flat btn-sm btn-primary" style="background-color: #4CAF50; border-color: #4CAF50;"><i class="fa fa-tag"></i> <?php echo number_format($row['cost']) ?></span>
                            <a href="./?page=view_package&id=<?php echo md5($row['id']) ?>" class="btn btn-sm btn-flat btn-warning" style="background-color: #4CAF50; border-color: #4CAF50;">View Package <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            <?php endwhile; ?>
